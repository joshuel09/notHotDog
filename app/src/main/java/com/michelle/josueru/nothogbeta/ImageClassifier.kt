...
/**
 * Created by Josueru on 11/04/18
 */
    ...
    fun detectHotdog(bitmap: Bitmap, callback: ((Boolean) -> (Unit))) {
        ...
        firebaseInterpreter.run(modelInput, inputOutputOptions)
                .addOnSuccessListener { output ->
                    ...
                    Log.d("CLASSIFY RESULT", "HOTDOG PROBABILITY : $hotDogProbability")
                    Log.d("CLASSIFY RESULT", "NOT HOTDOG PROBABILITY : $notHotDogProbability")
